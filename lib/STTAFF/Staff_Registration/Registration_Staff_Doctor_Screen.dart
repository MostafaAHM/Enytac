  ...
  Future<void> _submitRegistration() async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://164.92.111.149/api/doctors/'),
      );
      ...
      // request.fields['hospital'] = 'null'; // Adjust if necessary
      // request.fields['specializations'] = '[]'; // Adjust if necessary
      // request.fields['services'] = '[]'; // Adjust if necessary

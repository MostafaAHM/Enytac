...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  int? userdoctorID; // To hold the doctor ID
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      ...
      doctorID = prefs.getInt('doctorId'); // Get doctor ID
      userdoctorID = prefs.getInt('user'); // Get doctor ID
    });
  }
  ...
  Future<void> _fetchAvailableSlots() async {
    if (doctorID != null && selectedDate != null) {
      ...
      final url = Uri.parse(
          'http://164.92.111.149/api/users/$userdoctorID/availabilities/?page=1');
  ...
  Future<void> _onBookAppointment() async {
    if (selectedDate != null &&
      ...
      final int doctorId = doctorID!; // Use the doctor ID
      ...
      final appointmentData = {
        ...
        "doctor": doctorId, // Use the doctor ID
        "nurse": null, // Set to null if not required
